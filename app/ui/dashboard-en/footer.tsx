        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="col-span-1">
            ...
            <div className="space-y-2">
              <p>
                Design, molding, and assembly of Lighting components for the
                Automotive sector
              </p>
            </div>
          </div>
          ...
          <div className="col-span-1">
            ...
            <p className="space-y-2">
              ...
              <strong>Phone:</strong> +39 0141 1761990<br></br>
        ...
        <div>
          <ul className="flex flex-col md:flex-row">
            <li className="mb-2 md:mb-0 md:mr-4">
              <Link
                target="_blank"
                href={"/en/documents/Privacy-en sirion.pdf"}
              >
                Privacy Policy
              </Link>
            </li>
            <li className="md:mr-4">
              <Link
                target="_blank"
                href={"/en/documents/Ethical code Sirion.pdf"}
              >
                Ethical Code
              </Link>
            </li>
