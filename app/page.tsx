...
export default function Home() {
  ...
  return (
    ...
    <TitleHome description={"Qualità in"} description2={"ogni luce"} description3={"Grazie alla nostra esperienza offriamo un servizio a 360° dallo stampaggio di materie plastice alla finitura di componenti Lighting per il mercato Automotive."}/>
    <Description text={"Sirion Srl è un’azienda leader nel settore dell’illuminazione per il mercato automobilistico, specializzata nello stampaggio plastico ad iniezione."} text2={"Offriamo un servizio completo, dalla progettazione alla realizzazione del componente finale, garantendo qualità e affidabilità in ogni fase del processo."}></Description>
